...
class ProgramTree(ABC):
    """An abstract class. Represents a program as a hierarchical tree structure of interconnected nodes.
    ...
    :py:class:`~.nodes.ProgramNode` objects.
    ...
    def __init__(self, root: Union[ProgramNode, Type[ProgramNode]],
                 autofill=True):
        
        self._root: 'ProgramNode' = None
