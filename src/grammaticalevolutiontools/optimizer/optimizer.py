...
from ..evolution import cross_over, mutate_terminals, replace_random_branch
...
def cut_random_branch(agent:Agent, possible_node_types:list[Type[ProgramNode]], possible_replacements=list[Type[ProgramNode]]):
    replace_random_branch(agent, possible_node_types=possible_node_types,
...
class Optimizer:
    ...
    def create_next_generation(self):
        ...
        while len(self.population) + len(self.new_generation) < self.N:
            ...
            new_children = cross_over(agent1, agent2)
